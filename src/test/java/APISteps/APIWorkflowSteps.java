...
public class APIWorkflowSteps {
    ...
    **/
    ...
    public void a_request_is_prepared_to_retrieve_employee() {
        request = given()
    ...
    @Then("the retrieved ID {string} matches the globally stored employee ID")
    public void the_retrieved_id_matches_the_globally_stored_employee_id(String employeeIDFromResponse) {
